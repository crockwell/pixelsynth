...
python evaluation/eval_quality.py \
    ...
    --gpu 0 --result_folder output/images/mp3d/pretrained \
...
python evaluation/eval_quality.py \
    --vqvae --use_fixed_testset --model_setting gen_paired_img \
    --gpu 0 --result_folder output/images/mp3d/trained_model \
    --temperature=.5 --num_samples 1 \
    --dataset test_mp3d --dataset_folder /x/cnris/mp3d_eval/ \
...
python evaluation/eval_quality.py \
    ...
    --gpu 0 --result_folder output/images/mp3d/synsin_6x \
    --dataset test_mp3d --dataset_folder /x/cnris/mp3d_eval/ \
    --old_model modelcheckpoints/mp3d/synsin_6x.pth --no_outpainting
'